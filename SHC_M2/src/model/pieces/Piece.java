...
public abstract class Piece implements Movable {
	...
	public void MoveHelper(int newX, int newY, Direction d)
			throws OccupiedCellException, WrongTurnException, UnallowedMovementException {

		Cell oldCell = game.getCellAt(posI, posJ);
		Cell newCell = game.getCellAt(newX, newY);
		if (newX-posI>-1 && newX!=6 && d==Direction.UP)
			throw new UnallowedMovementException(this, d);
